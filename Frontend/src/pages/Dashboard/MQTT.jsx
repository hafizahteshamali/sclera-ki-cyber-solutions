      ...
      <div className="flex flex-col lg:flex-wrap lg:flex-row items-start lg:items-center justify-between lg:justify-start my-5 lg:my-0">
        {steps.map((step, index) => (
          <div key={index} className="flex items-center mb-1">
            ...
            <span
              onClick={() => setActiveTab(index + 1)}
              className={`ml-2 text-[14px] font-medium cursor-pointer ${
      ...
      {activeTab === 1 && (
        <div className="flex flex-col lg:flex-row gap-2">
          ...
          <div className="flex-1 flex flex-col gap-3">
            ...
            {/* Leistung */}
            <div className="bg-white rounded shadow border border-gray-300">
              <h2 className="text-[14px] font-semibold text-black p-2 bg-[#DAF1FF]">
                Leistung
              </h2>
              <div className="flex flex-col px-2 py-0.5">
                <div className="flex justify-between items-center border-b py-0.5 border-gray-300">
                  <label className="text-sm">
                    Max. Nachrichten während des Flugs
                  </label>
                  <input
                    type="number"
                    className="w-[50%] border border-gray-300 rounded px-2"
                  ...
                  <tr key={index} className="border-b border-gray-300">
                    ...
                    <td className="px-1 py-3 flex items-center space-x-1 text-[9px] sm:text-[10px] md:text-[12px]">
                      {row.status === "Verbunden" && (
                        <FaCircle className="text-green-500 h-2 w-2 sm:h-3 sm:w-3" />
                      )}
                      {row.status === "Getrennt" && (
                        <FaCircle className="text-red-500 h-2 w-2 sm:h-3 sm:w-3" />
                      )}
                    ...
                    <td className="px-1 py-3 flex space-x-1 text-[9px] sm:text-[10px] md:text-[12px]">
                      <button className="text-black bg-[#1976FB1A] px-1 py-0.5 rounded">
                        Edit
                      </button>
                      <button className="text-black border border-[#00000033] px-1 py-0.5 rounded">
                        Löschen
                      </button>
                    </td>
                  </tr>
      ...
      {activeTab === 2 && (
        <div className="flex flex-col lg:flex-row gap-2">
          ...
          <div className="flex-1 flex flex-col gap-3 overflow-y-auto lg:overflow-hidden">
            {/* Authentifizierung */}
            <div className="bg-white rounded shadow border border-gray-300">
              <h2 className="text-[14px] font-[400] text-black bg-[#DAF1FF] p-2">
                Authentifizierung
              </h2>
            ...
            <div className="bg-white rounded shadow border border-gray-300">
              ...
              <div className="flex flex-col px-2">
                ...
                <div className="flex justify-between items-center border-b py-1 border-gray-300">
                  ...
                  <input type="text" placeholder="Geben Sie hier ein" className="w-[50%] border border-gray-300 rounded px-2" />
                </div>
                <div className="flex justify-between items-center py-1">
