...
const AlarmEvents = () => {
  ...
  return (
    <div className="rounded-lg p-2 max-w-7xl mx-auto">
      {/* Header */}
      <div className="flex flex-col gap-4 sm:gap-6 mb-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-stretch gap-4 w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-1/2">
            <button className="bg-[#1976FB] hover:bg-blue-600 text-white font-[400] py-1.5 text-[16px] w-full lg:w-[40%] flex justify-center items-center rounded-md transition-colors">
              Bulk Ack
            </button>
            <button className="bg-[#FCFDFF] hover:bg-gray-100 text-black border border-gray-300 font-[400] py-1.5 w-full lg:w-[40%] flex justify-center items-center rounded-md transition-colors">
              CSV Export
            </button>
          </div>
          ...
          <thead className="bg-gray-100">
            <tr className="text-sm lg:text-base">
              {columns.map((col, i) => (
                <th
                  key={i}
                  className="px-2 sm:px-4 md:px-6 py-2 sm:py-3 lg:py-3 text-left font-[600] text-black"
                >
            ...
            {events.map((event, rowIndex) => (
              ...
              >
                {columns.map((col, colIndex) => (
                  <td
                    key={colIndex}
                    className="px-2 sm:px-4 md:px-6 py-2 sm:py-3 lg:py-3 break-words text-black"
                  >
                    {col === "severity" ? (
                      <span
